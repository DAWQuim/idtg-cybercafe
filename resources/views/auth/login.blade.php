        ...
        <div class="bg-[#2B2B2B] bg-opacity-70 min-h-[80vh] flex justify-center items-center py-10">
            <div class="p-8 rounded-lg text-white w-96 border border-white">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4">
                    ...
                    <div>
                        <label class="block mb-1 font-medium">
                            <div class="flex items-center gap-2">
                                ...
                                >
                                    <path fill-rule="evenodd"
                                          d="M12 2a6 6 0 00-6 6v4H6a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2v-8a2 2 0 00-2-2h-2v-4a6 6 0 00-6-6zm-4 8V8a4 4 0 118 0v2h-8z"
                                          clip-rule="evenodd"
                                    />
                                </svg>
                                Contraseña
                    ...
                    <p class="mb-4 w-full text-center text-lg font-bold text-red-500">{{ $message }}</p>
                    @enderror

                    <button type="submit"
                            class="w-full p-2 rounded bg-green-500 hover:bg-green-600 text-white font-bold"
                    >Iniciar Sesión
                    </button>
                </form>

                <p class="mt-4 text-center">
                    <a href="{{ route('password.request') }}" class="text-green-400 hover:underline">¿Olvidaste tu
                        contraseña?</a>
                </p>
                <p class="text-center">
                    ¿No tienes cuenta?
