<footer class="bg-black text-white">
    ...
    <div class="flex py-6 justify-around text-sm">
    ...
    <div class="flex flex-col items-center py-4 gap-4 bg-[#0a0a0a] text-gray-300 text-sm">
        <!-- Enlaces legales centrados -->
        <div class="flex gap-4 px-4">
            <a href="{{ route('legal.notice') }}" class="w-fit hover:underline">Aviso Legal</a>
            <a href="{{ route('legal.privacy') }}" class="w-fit hover:underline">Política de Privacidad</a>
            <a href="{{ route('legal.cookies') }}" class="w-fit hover:underline">Política de Cookies</a>
            <a href="{{ route('legal.terms') }}" class="w-fit hover:underline">Términos y Condiciones</a>
        </div>
